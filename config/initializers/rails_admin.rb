# RailsAdmin config file. Generated on April 28, 2012 15:37
...
RailsAdmin.config do |config|
  ...
  config.included_models = [User, Customer, Invoice, InboundInvoice, JobOrder, ActivityType, UserActivity]
  ...
  config.main_app_name = ['Scrooge', 'Admin']
  ...
  # config.included_models = [Customer, User]
